...
const PlaceOrderScreen = () => {
  ...
  useEffect(() => {
    if (total.data) {
      window.location.assign(total.data);
      //   window.open(total.data);
    }
  }, [total]);
        ...
        <Col md={8}>
          <ListGroup>
            ...
            <ListGroup.Item>
              ...
              <p>
                Thanh toán bằng: <strong>{cart.paymentMethod}</strong>
              </p>
            </ListGroup.Item>
                    ...
                    <ListGroup.Item key={index}>
                      <Row>
                        ...
                        <Col className="d-flex align-items-center" md={5}>
                          ...
                          ={' '}
                          {(item.count * item.price)?.toLocaleString('vi', {
                            style: 'currency',
                            currency: 'VND',
                          })}
                        </Col>
              ...
              <ListGroup.Item className="d-flex justify-content-center py-4">
                {cart.paymentMethod === 'Tiền mặt' ? (
                  ...
                  <Button
                    ...
                    className="shadow-sm d-flex justify-content-center align-items-center p-3"
                  >
                    <Image
                      style={{ height: '50px' }}
                      ...
                      alt="paypal"
                    ></Image>
                    <h5 className="my-0 mx-3" style={{ color: 'black' }}>
                      Thanh toán
                    </h5>
                  </Button>
                )}

...
const ContactScreen = () => {
    ...
    return (
        <Container className='p-4 mt-4' style={{border: '2px solid #cccccc', borderRadius: '15px'}}>
                ...
                <Col xl={6}>
                    ...
                    <Row className='mb-3'>
                        ...
                        <div className='d-flex align-items-center'>
                            ...
                            <p className='mx-2 my-0'>HDKMart@gmail.com</p>
                        </div>
                    </Row>
                    <Row className='mb-3'>
                    ...
                    <Row className='mb-3'>
                        <h6>Thông báo:</h6>
                        <div className='d-flex align-items-center'>
                            <p className='my-0'>Cám ơn quý khách đã tin tưởng và mua sắm tại HDKMart. Trong quá trình mua sắm, nếu có 

...
export const productUnsoldReducer = (state = { unsold: [] }, action) => {
    switch (action.type) {
        case PRODUCT_UNSOLD_REQUEST:
            return { loading: true, ...state }
        case PRODUCT_UNSOLD_SUCCESS:
            return { loading: false, unsold: action.payload }
        case PRODUCT_UNSOLD_FAIL:
            return { loading: false, error: action.payload }
        default:
            return state
    }
...
export const productFeatureReducer = (state = { feature: [] }, action) => {
    switch (action.type) {
